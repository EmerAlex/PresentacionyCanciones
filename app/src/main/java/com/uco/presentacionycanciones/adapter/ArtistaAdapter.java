package com.uco.presentacionycanciones.adapter;
...
public class ArtistaAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view != null) {
            ...
            view = inflater.inflate(R.layout.item_artistas, parent, false);
    ...
    class ViewHolder {
        ...
        @BindView(R.id.nombreArtista)
        TextView nombreArtista;
        @BindView(R.id.generoMusical)
